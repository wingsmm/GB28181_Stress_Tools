...
public:
	...
	// Public methods to control device state
	void stopRunning() { is_running = false; }
	void stopPushingStream() { is_pushing = false; }
	...
	bool isMobilePositionRunning() const { return is_mobile_position_running; }
